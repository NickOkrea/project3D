...
export default function Home() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-between bg-black overflow-hidden">
      ...
      {/* main */}
      <main className="col-span-3 lg:col-span-1 absolute lg:relative right-0 lg:right-auto h-full w-3/4 lg:w-auto pl-5 bg-amber-500/50 backdrop-blur-xs overflow-scroll no-scrollbar z-10 lg:z-auto lg:backdrop-blur-none">
      ...
      {/* modelo 3d */}      
      <div className="col-span-2 lg:col-span-1   lg:h-full">
          <Canvas
